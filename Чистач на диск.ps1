...
#GUI Variables
$FormTitleText = "Чистење диск од Џим Тајлер (PowerShellEngineer.com)"
$SelectDiskLabelText = "Избери диск:"
$FreeSpaceLabelText = "Слободен простор (гигабајти): "
$TotalSpaceLabelText = "Вкупен простор (гигабајти): "
$JunkFoundLabelText = "пронајден ѓубре (гигабајти):"
$CleanDiskBtnText = „Исчисти го дискот *Избриши датотеки*“
$SpaceCleanedLabelText = "Исчистен простор (гигабајти): "
$LogFileLabelText = "Најдена е датотека за евиденција: $abcdefg"
$CreditLabelText = "Скрипта од Џим Тајлер - PowerShellEngineer.com"
$LogFileLocatedText = „Пронајдена е датотека за евиденција“
$AnalyzingDriveText = "Анализа на дискови..."
$BrowsersAreRunningText = "Прелистувачите работат... Известете го корисникот..."
$PleaseCloseBrowsersText = "Затворете ги сите веб-прелистувачи и обидете се повторно."
$CleaningDriveText = "Чистење на диск..."
